  ...
  return (
    <html lang="en">
        ...
        <head>
            ...
            <meta http-equiv="X-UA-Compatible" content="IE=Chrome"></meta>
        ...
        <body class="container-fluid">
            ...
            <header id="header">
                ...
                <nav class="navbar">
                    <ul >
                        <li class="nav-item"><a href="#sobre"> <strong>Sobre</strong>  </a></li>
                        <li class="nav-item"><a href="#projetos"> <strong>Projetos</strong>  </a></li>
                        <li class="nav-item"><a href="#contato"> <strong>Contato</strong>  </a></li>
                    </ul>                   
                </nav>
